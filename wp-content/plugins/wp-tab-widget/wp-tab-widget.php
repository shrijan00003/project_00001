...
if ( !class_exists('wpt_widget') ) {
	class wpt_widget extends WP_Widget {
		...
		function widget( $args, $instance ) {	
	        ...
	        $available_tabs = array('popular' => __('लोकप्रीय', 'wp-tab-widget'), 
	            'recent' => __('भर्खरै', 'wp-tab-widget'), 
	    ...
	    function tab_pagination($page, $last_page) {  
			...
			<div class="wpt-pagination">     
				<?php if ($page > 1) : ?>               
					<a href="#" class="previous"><span><?php _e('&laquo; अघि', 'wp-tab-widget'); ?></span></a>      
				<?php endif; ?>        
				<?php if ($page != $last_page) : ?>     
					<a href="#" class="next"><span><?php _e('थप &raquo;', 'wp-tab-widget'); ?></span></a>      
				<?php endif; ?>          
			</div>                   
			<div class="clear"></div>
