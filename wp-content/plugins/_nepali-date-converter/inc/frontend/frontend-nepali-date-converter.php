 ...
 */
if ( ! class_exists( 'Frontend_Nepali_Date_onverter' ) ) {
    /**
     ...
     * @since 1.0
     */
    class Frontend_Nepali_Date_onverter {
        ...
        public function nepali_date_converter( $ndc_datas ){
            ...
            $today_nepali_date_data = eng_to_nep_date(array(
                'year' => $current_eng_yr,
            ...
            if( isset( $ndc_datas ['disable_convert_nep_to_eng'] ) && 1 == $ndc_datas ['disable_convert_nep_to_eng'] ){
            ...
            if( isset( $ndc_datas ['disable_convert_eng_to_nep'] ) && 1 == $ndc_datas ['disable_convert_eng_to_nep'] ){
                /*disable nep to eng convert*/
