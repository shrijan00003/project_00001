...
if ( ! class_exists( 'Coder_Nepali_Calendar' ) ){
	class Coder_Nepali_Calendar {
		/*added*/
		/**
		 ...
		 *
		 */
		protected $long_eng_nep_mth = array(
			"January" => 'बैशाख',
			"February" => 'जेष्ठ',
			"March" => 'असार',
			"April" => 'साउन',
		 ...
		 *
		 */
		protected $long_eng_nep_mth_in_eng = array(
			"January" => 'Baishakh',
			"February" => 'Jestha',
			"March" => 'Ashad',
			"April" => 'Shrawan',
		 ...
		 *
		 */
		protected $short_eng_nep_mth = array(
			"Jan" => 'बैशाख',
			"Feb" => 'जेष्ठ',
			"Mar" => 'असार',
			"Apr" => 'साउन',
		 ...
		 *
		 */
		protected $short_eng_nep_mth_in_eng = array(
			"Jan" => 'Baishakh',
			"Feb" => 'Jestha',
			"Mar" => 'Ashad',
			"Apr" => 'Shrawan',
		 ...
		 *
		 */
		protected $long_eng_nep_day = array(
			"Sunday" => 'आइतवार',
			"Monday" => 'सोमवार',
			"Tuesday" => 'मङ्लबार',
			"Wednesday" => 'बुधबार',
		 ...
		 *
		 */
		protected $long_eng_nep_day_eng = array(
			"Sunday" => 'Aaitabar',
			"Monday" => 'Sombar',
			"Tuesday" => 'Mangalbar',
			"Wednesday" => 'Budhabar',
		 ...
		 *
		 */
		protected $short_eng_nep_day = array(
			"Sun" => 'आइत',
			"Mon" => 'सोम',
			"Tue" => 'मङ्ल',
			"Wed" => 'बुध',
		 ...
		 *
		 */
		protected $short_eng_nep_day_eng = array(
			"Sun" => 'Aaita',
			"Mon" => 'Som',
			"Tue" => 'Mangal',
			"Wed" => 'Budha',
		...
		public function eng_to_nep( $input_date = array(),$date_format = 'nep_char', $format = 'D, F j, Y' ) {
			...
			if($chk !== TRUE) {
				...
				if( 'eng_char' == $date_format ){
					...
					$nepali_date = strtr( $formatted_date, $this->eng_nep_num );
